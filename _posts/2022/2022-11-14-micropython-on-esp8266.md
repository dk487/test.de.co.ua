...
Але я [почитав мануал][1], погуглив, щось десь здогадався і в мене все вийшло. 
...
Як у більшості плат на ESP8266, тут є позначки D0, D1, D2 і так далі, які [не співпадають з номерами GPIO][4]. Зокрема, GPIO5 це D1 (це його я підключаю до кнопки). Де логіка?
